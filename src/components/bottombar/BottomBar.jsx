    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 w-full bg-gradient-to-r from-gray-900 via-black to-gray-900 border-t-2 border-cyan-500/30 px-4 py-3 z-50">
            ...
            <div className="flex items-center justify-between gap-4 max-w-screen-2xl mx-auto">
                ...
                {/* ESQUERDA - Info da música (largura fixa no desktop) */}
                <div className="flex items-center gap-3 md:gap-4 min-w-0 w-full md:w-1/4">
                ...
                {/* CENTRO - Controles (Desktop) - agora com flex-1 para crescer */}
                ...
                {/* DIREITA - Controles Mobile e Volume Desktop (largura fixa no desktop) */}
